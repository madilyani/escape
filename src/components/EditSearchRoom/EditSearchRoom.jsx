...
export default function EditSearchRoom({ form, updateForm, setShowCalendar }) {
  ...
  return (
    <div className="searchMob__room editt" ref={wrapper}>
      <div className="searchPopActs__outer">
        <div className="editSearch__row" onClick={clickHandler}>
          <div className="editSearch__room">
            <h6>Adults</h6>
            <input type="text" value={adults} readOnly placeholder="0" />
          </div>
          <div className="editSearch__room">
            <h6>Children</h6>
            <input type="text" value={children} readOnly placeholder="0" />
          </div>
          <div className="editSearch__room">
            <h6>Room</h6>
            <input
